# ADOPT.md — 기존 프로젝트 채택 (THROUGHLINE Team)

이미 코드가 있는 프로젝트에 THROUGHLINE Team을 적용합니다. 요구사항이 아니라 **기존 코드를 분석해 현재 상태를 역문서화**하고, 팀 동시 개발 구조를 세웁니다.
...
1. `THROUGHLINE/`에 기존 산출물이 있으면 **이미 채택됨** → 재채택하지 말고 보고만.
