...
- **Operator Dispatch**: Handle all operators (binary: `+`, `-`, `*`, `/`, `pow`, `lt`, `gt`, `eq`; unary: `neg`)
- **Exports**: `evaluate_ast(ast: ASTNode) -> int`

### `rpn.py`
- **Convert to RPN**: Transform AST to postfix (Reverse Polish Notation)
- **Operator Dispatch**: Handle all operators (binary: `+`, `-`, `*`, `/`, `pow`, `lt`, `gt`, `eq`; unary: `neg`) in postfix context
...
| `lt` | 2 | ✓ | ✓ | Less than comparison; returns 1 (true) or 0 (false); both visitors fully support |
| `gt` | 2 | ✓ | ✓ | Greater than comparison; returns 1 (true) or 0 (false); both visitors fully support |
| `eq` | 2 | ✓ | ✓ | Equality comparison; returns 1 (true) or 0 (false); both visitors fully support |
