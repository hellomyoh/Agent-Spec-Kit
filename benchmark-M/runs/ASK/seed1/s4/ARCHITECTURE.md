...
| `pow` | 2 | ✓ | ✓ | Binary exponentiation |
| `lt` | 2 | ✓ | ✓ | Binary less-than comparison; returns 1 if true, 0 if false |
| `gt` | 2 | ✓ | ✓ | Binary greater-than comparison; returns 1 if true, 0 if false |
| `eq` | 2 | ✓ | ✓ | Binary equality comparison; returns 1 if true, 0 if false |
