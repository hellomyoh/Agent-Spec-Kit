...
## Next session (S3) — expected work
- `schedule_task`: approved → scheduled (slot conflict check already implemented in S0).
- `complete_task` or other lifecycle steps if added to ticket.
- Possibly: audit/comment/search enhancements.
