...
🌐 [English](RESULTS_SUMMARY.md) · **한국어**

> 방법론: [METHODOLOGY.ko.md](METHODOLOGY.ko.md) · 단발/누적/복원 상세: [FINAL_REPORT.ko.md](FINAL_REPORT.ko.md) · 중규모 설계: [REALWORLD_DESIGN.md](REALWORLD_DESIGN.md) · 중규모 파일럿(B7 Stage 0) 상세: `benchmark-realapp/`은 후속 벤치마크로 대체되어 저장소에서 제거됨(커밋 f6c8cc9) — 요약은 본 문서 §1 및 [FINAL_REPORT.ko.md](FINAL_REPORT.ko.md) 참조
