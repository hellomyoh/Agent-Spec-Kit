...
equality filter on arbitrary item fields (`where=...`), and stable ordering of
the results by a field (`sort_by=...`).
...
The `limit` argument is part of the fixed contract but is not active yet.
"""
...
class Catalog:
    ...
    def search(
        ...
        """Return items matching the given criteria, optionally sorted.
        ...
        `limit` is part of the fixed contract but is not active yet.
        """
