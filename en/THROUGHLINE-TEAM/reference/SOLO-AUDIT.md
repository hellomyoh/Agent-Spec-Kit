...
> live inside the `THROUGHLINE/` folder. All artifact paths in this document are relative to `THROUGHLINE/`.
> During the audit, also check that no artifact has been created outside of THROUGHLINE/.
