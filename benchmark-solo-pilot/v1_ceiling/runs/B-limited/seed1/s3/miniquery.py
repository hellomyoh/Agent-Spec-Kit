...
The remaining query() parameter (select) is present to honour the pinned
signature but is not yet implemented.
"""
...
class Store:
    ...
    def query(self,
        ...
        The remaining parameter (select) is part of the pinned contract signature
        but is not implemented in this session's ticket.
        """
