...
stays stable. The limit/offset/select parameters are part of the fixed
...
class Store:
    ...
    def query(
        ...
        The limit/offset/select parameters are part of the fixed contract but
        are reserved for future tickets and are not yet honoured.
        """
