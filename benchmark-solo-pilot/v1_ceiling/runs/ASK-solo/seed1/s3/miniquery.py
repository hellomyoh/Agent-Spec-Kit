...
stays stable. The select parameter is part of the fixed contract but is
reserved for a future ticket and is not yet honoured.
"""
...
class Store:
    ...
    def query(
        ...
        The select parameter is part of the fixed contract but is reserved for
        a future ticket and is not yet honoured.
        """
        ...
        # Pagination (S3): applied LAST, after where-filtering and sorting.
